...
When `omnitech-rulesync` is not installed, invoke it from the target repository with `pnpm dlx --allow-build=@omnitech/rulesync github:omnitech-solutions/omnitech-rulesync#v0.1.1` followed by the command and arguments below.
